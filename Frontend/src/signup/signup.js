...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response1 = await fetch('https://lms-joydeep.onrender.com/lms/users/register', {
        method: 'POST',
        headers: {
      ...
      const response2 = await fetch('https://lms-joydeep.onrender.com/lms/teachers/register', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
